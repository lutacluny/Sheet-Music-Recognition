...
from note_group_dicts import kinds_top, kinds_bottom, kind_dict, help_line_dict, lines, note_to_index 
...
def main():
    if os.path.isdir("svg_notes_grouped"):
        shutil.rmtree("svg_notes_grouped")   
...
def supply_dir(note, kind):
    dir_name = "{}/{}_{}".format("svg_notes_grouped", note, kind)
